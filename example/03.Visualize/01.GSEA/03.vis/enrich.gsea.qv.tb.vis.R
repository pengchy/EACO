...
#read in data sets
load("/panfs/home/kang/yangpc/bin/EnrichPipeline/EACO_r20150201/example/03.Visualize/01.GSEA/02.cluster/enrich.gsea.qv.tb.logp.tree.RData")
...
et.sig.log <- read.table("/panfs/home/kang/yangpc/bin/EnrichPipeline/EACO_r20150201/example/03.Visualize/01.GSEA/enrich.gsea.qv.tb.logp",sep="\t")
...
write.csv(dynamic.tree.dt,file="/panfs/home/kang/yangpc/bin/EnrichPipeline/EACO_r20150201/example/03.Visualize/01.GSEA/03.vis/enrich.gsea.qv.tb.cluster_desc.csv")
...
pdf("/panfs/home/kang/yangpc/bin/EnrichPipeline/EACO_r20150201/example/03.Visualize/01.GSEA/03.vis/enrich.gsea.qv.tb.tree_pairs_indx.pdf",width=10,height=10)
...
save(hcl.lst.al,dynamic.tree,abr,dst.lst,go.dt,setDes,et.sig.log,file="/panfs/home/kang/yangpc/bin/EnrichPipeline/EACO_r20150201/example/03.Visualize/01.GSEA/03.vis/enrich.gsea.qv.tb.logp.vis.RData")
